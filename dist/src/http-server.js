...
const TOOLS = [
    {
        ...
        description: "Full-text search across BfDI decisions (Bußgeldbescheide, Verfahren, Anordnungen). Returns matching decisions with reference, entity name, fine amount, and GDPR articles cited. Search in German for best results.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Search BfDI and DSK guidance documents: Orientierungshilfen, Kurzpapiere, Hinweise, and Empfehlungen.",
        inputSchema: {
            type: "object",
            properties: {
            ...
            switch (name) {
                ...
                case "de_dp_about": {
                    return textContent({
                        name: SERVER_NAME,
                        version: pkgVersion,
                        description: "BfDI (Bundesbeauftragter für den Datenschutz und die Informationsfreiheit) MCP server. Provides access to German federal data protection authority decisions, sanctions, and official guidance documents.",
