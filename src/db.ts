/**
 * SQLite database access layer for the BfDI MCP server.
 *
 * Schema:
 *   - decisions    — BfDI deliberations, sanctions, and Bußgeldbescheide
 *   - guidelines   — BfDI guidance documents, Orientierungshilfen, and Hinweise
