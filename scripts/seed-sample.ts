...
const decisions: DecisionRow[] = [
  ...
  // Deutsche Wohnen SE
  {
    ...
    summary:
      "Die Berliner Datenschutzbeauftragte verhängte eine Geldbuße von 14,5 Millionen Euro gegen Deutsche Wohnen SE wegen fehlender Löschkonzepte — das Archivierungssystem für Mieterdaten erlaubte keine Löschung nicht mehr benötigter personenbezogener Daten.",
    full_text:
...
const guidelines: GuidelineRow[] = [
  ...
  },
  {
    ...
    summary:
      "Diese Orientierungshilfe der DSK beschreibt, welche technischen und organisatorischen Maßnahmen (TOMs) Verantwortliche und Auftragsverarbeiter nach Art. 32 DSGVO umsetzen müssen, um ein dem Risiko angemessenes Schutzniveau zu gewährleisten.",
    full_text:
